...
namespace UnityEngine.Advertisements
{
    ...
    {
        private Texture2D placeHolderLandscape, placeHolderPortrait;
        ...
        public void init()
        {
            ...
            placeHolderLandscape =
                textureFromFile(Application.dataPath + "/Standard Assets/UnityAds/Textures/test_unit_800.png");
            placeHolderPortrait =
                textureFromFile(Application.dataPath + "/Standard Assets/UnityAds/Textures/test_unit_600.png");
        }
        ...
        private byte[] textureBytesForFrame(string imageURL)
        {
            ...
            using (FileStream fileStream = File.OpenRead(imageURL))
            {
                ...
                int num2 = 0;
                int num3;
                while ((num3 = fileStream.Read(array, num2, num - num2)) > 0) { num2 += num3; }
            }
            return array;
        }
        ...
        private void windowFunc(int id)
        {
            ...
            if (GUI.Button(new Rect(Screen.width - 150, 0, 150, 50), @"Close")) { Hide(); }
        }
